...
<main class="form-signin">
  <form action="<?php echo url('form/storedata');?> " value="<?php  old('value') ?>" method="post">
    ...
    <div class="form-floating">
    <label for="floatingInput">LinkedIn URL</label> <br>
      <input type="text" name="linkedin" class="form-control" id="floatingInput" placeholder="LinkedIn URL">
    </div>
    <br>
